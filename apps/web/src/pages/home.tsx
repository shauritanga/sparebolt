...
export function HomePage() {
  ...
  return (
    <div className="space-y-8">
      {/* Seller-subscribed promo carousel (auto-slides) */}
      <PromoCarousel />

      {/* Search — desktop/tablet only (mobile uses bottom nav Browse) */}
      <form
        onSubmit={onSearch}
        className="hidden md:flex flex-col gap-2 sm:flex-row"
      >
